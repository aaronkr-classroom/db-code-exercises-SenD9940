...
-- 간단한 ERD
 강사 --- 1:N --- 강좌 --- N:M --- 회원 (기존)
 강사 --- 1:N --- 강좌 --- 1:N --- 수강신청 --- N:1 --- 회원 (변경 후)
*/
...
(1, '김영희', '요가', '010-111-1111'),
(2, '박민수', '드로잉', '010-2222-2222'),
(3, '이지은', '영어 회화', '010-3333-3333');
...
INSERT INTO members2(name, phone, join_date) VALUES('홍길동', '010-1234-5678', CURRENT_DATE);
...
SELECT m.name AS 회원명, c.class_name AS 강좌명, r.register_date AS 신청일
FROM registrations r
JOIN members m ON r.member_id = m.member_id
JOIN classes c ON r.class_id = c.class_id;
